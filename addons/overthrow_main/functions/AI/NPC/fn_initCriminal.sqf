...
if(random 100 > 30) then {
	...
	_weapon = selectRandom OT_CRIM_Pistols;
};
_base = [_weapon] call BIS_fnc_baseWeapon;
_magazine = (getArray (configFile / "CfgWeapons" / _base / "magazines")) select 0;
if (isNil "_magazine") then {_weapon = (OT_CRIM_Pistols) call BIS_fnc_selectRandom;_base = [_weapon] call BIS_fnc_baseWeapon;_magazine = (getArray (configFile / "CfgWeapons" / _base / "magazines")) select 0;};
